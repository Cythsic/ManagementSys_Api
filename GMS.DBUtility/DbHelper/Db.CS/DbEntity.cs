...
namespace T4
{
    ...
    {
        //数据库名
        public static readonly string Server = "sudev03";//"127.0.0.1";
        public static readonly string DbDatabase = "GMS";
        public static readonly string Uid = "mesuser";
        public static readonly string Pwd = "mes_2011";
        //数据库类型
        ...
        //命名空间
        public static readonly string Namespace = "GMS";
        //需要生成的表名，多张表用,分割
        public static readonly string Tables = "HR_User";//"users,rows,titles"
    }
